...
def test_external_labs_guide_covers_download_setup_and_labs_zero_through_ten():
    ...
    for relative in (
        ...
        "09-consensus-vs-meaning/README.md",
        "10-insecure-defaults/README.md",
    ):
...
def test_repository_readme_links_the_newcomer_labs_guide():
    ...
    assert "[Practical Labs 0–10](labs/README.md)" in text
